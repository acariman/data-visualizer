...
class CSVPopUpDesign(object):
    ...
    def setup_ui(self, pop_up):
        ...
        self.layout.setWidget(
            0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.layer_text
        )
        self.sep_label = QtWidgets.QLabel(parent=pop_up)
        self.sep_label.setAlignment(
        ...
        self.layout.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.sep_label
        )
        self.sep_line = QtWidgets.QLineEdit(parent=pop_up)
        self.sep_line.setObjectName("sep_line")
        self.layout.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.sep_line
        )
        ...
        self.layout.setWidget(
            5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.color_label
        )
        ...
        self.color_cb.addItem("")
        self.layout.setWidget(
            5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.color_cb
        )
